...
let virtual-env = "D:\Дима\инф в приложении к отрасли\lab03\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Дима\инф в приложении к отрасли\lab03\venv\Scripts\deactivate.nu"
